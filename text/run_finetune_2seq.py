...
import pandas as pd
import csv
from modeling_bert import BertForSequenceClassification_textCNN_with2seq
from transformers import (
    ...
    # BertForSequenceClassification_textCNN_with2seq,
...
MODEL_CLASSES = {
    ...
    "dna2seq_textcnn": (BertConfig, BertForSequenceClassification_textCNN_with2seq, DNATokenizer),
...
def train(args, train_dataset_before, train_dataset_after, model, tokenizer):
    ...
    # big_lr = ["textcnn", "fc", "classifier"]
    big_lr = ["my_fc"]
    grad = ["textcnn", "fc", "classifier", "bert.encoder.layer.11", "bert.encoder.layer.10", "bert.encoder.layer.9"]
