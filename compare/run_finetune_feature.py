...
from transformers import BertForSequenceClassification, BertForLongSequenceClassification, BertForLongSequenceClassificationCat
from transformers import DistilBertConfig, DistilBertForSequenceClassification, DistilBertTokenizer, FlaubertConfig, FlaubertForSequenceClassification, FlaubertTokenizer, RobertaConfig, BertTokenizer, DNATokenizer
from transformers import RobertaForSequenceClassification, RobertaTokenizer, XLMConfig, XLMForSequenceClassification, XLMRobertaConfig, XLMRobertaForSequenceClassification,  XLMRobertaTokenizer
from transformers import XLMTokenizer, XLNetConfig, XLNetForSequenceClassification, XLNetTokenizer, get_linear_schedule_with_warmup
...
def predict(args, model, tokenizer, prefix=""):
    ...
    for pred_task, pred_output_dir in zip(pred_task_names, pred_outputs_dirs):
        ...
        output_fea_file = os.path.join(pred_output_dir, "features.npy")
