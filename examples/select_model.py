...
from transformers import (
    ...
    BertForSequenceClassification_textCNN_cat,
    BertForSequenceClassification_textCNN_sum,
    BertTokenizer,
    DNATokenizer,
    DistilBertConfig,
...
MODEL_CLASSES = {
    ...
    "dnatextcnn_cat": (BertConfig, BertForSequenceClassification_textCNN_cat, DNATokenizer),
    "dnatextcnn_sum": (BertConfig, BertForSequenceClassification_textCNN_sum, DNATokenizer),
...
def train(args, train_dataset, model, tokenizer):
    ...
    big_lr = ["textcnn", "fc", "classifier", "fan"]
    grad = ["textcnn", "fc", "classifier", "bert.pooler", "bert.encoder.layer.11", "bert.encoder.layer.10",
            "bert.encoder.layer.9"]
    # grad = ["textcnn", "fc", "classifier"]
...
def main(args):
    ...
    if not args.do_visualize and not args.do_ensemble_pred:
        ...
        config.hidden_layer_number = args.hidden_layer_number
        config.hidden_layer_id = args.hidden_layer_id
...
if __name__ == "__main__":
    ...
    args.hidden_layer_number = 4
    args.hidden_layer_id = -1
    args.model_name = "mutant_Bert_100_2506+10020_5_dnatextcnn_Concat-Last-Four-Hidden"
    # default = 5
    if args.model_num != 1:
        ##进行交叉验证  需要改变一下目录
        if args.do_predict == False:
            for num in range(args.model_num):
                args.data_dir = data_dir + str(num) + "/after/"
    ...
    #
    # args.hidden_layer_number = 1
    # args.hidden_layer_id = -2
    # args.model_name = "mutant_Bert_100_2506+10020_5_dnatextcnn_Second-to-Last-Hidden"
    #
    # # default = 5
    # if args.model_num != 1:
    #     ##进行交叉验证  需要改变一下目录
    ...
    # args.hidden_layer_number = 4
    # args.hidden_layer_id = -1
    # args.model_name = "mutant_Bert_100_2506+10020_5_dnatextcnn_Weighted-Sum-Last-Four-Hidden"
    # args.model_type = "dnatextcnn_sum"
    #
    # # default = 5
    # if args.model_num != 1:
    #     ##进行交叉验证  需要改变一下目录
    ...
    args.hidden_layer_number = 12
    args.hidden_layer_id = -1
    args.model_name = "mutant_Bert_100_2506+10020_5_dnatextcnn_Weighted-Sum-all-Hidden"
    args.model_type = "dnatextcnn_sum"
