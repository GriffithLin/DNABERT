...
def predict(args, model, tokenizer, prefix=""):
    ...
    for pred_task, pred_output_dir in zip(pred_task_names, pred_outputs_dirs):
        ...
        np.save(output_pred_file, np.concat([probs, preds], axis = 1))
...
def main():
    ...
    parser.add_argument("--model_num", type=int, default=3, help="Number of work to train")
...
# 5
# --output_dir
# /data3/linming/DNABERT/examples/output/mutant_Bert_100_2506+10020_5_dna_1e-4/
...
# 8
# --model_name
# mutant_Bert_100_2506+10020_5_dna_1e-4

if __name__ == "__main__":
    # args = get_config()
    # args.tokenizer_name = "dna5"
    ...
    # args.output_dir = "/data3/linming/DNABERT/examples/output/mutant_Bert_225_5_dna_1e-4/"
